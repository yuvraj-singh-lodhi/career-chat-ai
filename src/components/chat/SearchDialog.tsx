    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            <Card glass className="bg-black/20 text-zinc-100 border-zinc-700 shadow-lg">
              <CardHeader>
                <CardTitle>Search Chats</CardTitle>
                <CardDescription>Find sessions and messages quickly</CardDescription>
              </CardHeader>
                ...
                <div className="flex flex-col gap-3 max-h-80 overflow-y-auto">
                  {results?.map((session) => (
                    <Card
                      ...
                      className="p-3 bg-zinc-800 hover:bg-zinc-700 cursor-pointer transition"
                    >
